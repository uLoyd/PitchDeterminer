...
class FrequencyMath {
    ...
    distanceBetweenNotes(sound1 = FrequencyMath.soundConstructor("A", 4), sound2 = this) {
        const dist1 = FrequencyMath.getDistanceFromNote(sound1.sound, sound1.octave);
        const dist2 = FrequencyMath.getDistanceFromNote(sound2.sound, sound2.octave);

        return dist1 - dist2;
    }

    // compares sounds without octaves
    soundDistanceForward(sound1 = FrequencyMath.soundConstructor("A", 4), sound2 = this) {
    ...
    getFrequencyError(fx = this.initialFrequency){
        ...
        return {
            ...
            totalCentsBetweenNotes: this.getIntervalCents(FrequencyMath.getFrequencyFromDistance(nextNote), targetFrequency)
        };
    }
