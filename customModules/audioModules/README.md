...
| async getDeviceList  | direction: Optional[Device.direction]                                                                                                                                                                                                                                                                                                                                   | Array[Device] | Returns array of Device instances related to available audio IO devices. If no direction is specified all devices will be returned, otherwise only the devices in specified direction.                                                                                                                                                                                                                                                                                                                                                                                                         | Returns array of Device instances related to available audio IO devices. If no direction is specified all devices will be returned, otherwise only the devices in specified direction.  |
